...
% 6) A formação de H2 é equimolar a de H2O (g = f).
% ========================================================== %
...
h2_p = x_ref(4);                                                % Número de mols de H2 na corrente de saída de Produtos (P)
nt_p = x_ref(2) + x_ref(3) + x_ref(4) + h2_p + nitrog_f;        % Número total de mols da corrente de saída de Produtos (P)

xc_comp = [(1/nt_prop) (x_cramer(1)/nt_ar) (nitrog_i/nt_ar) (x_cramer(2)/nt_p) (x_cramer(3)/nt_p) (x_cramer(4)/nt_p) (h2_p/nt_p) (nitrog_f/nt_p)];
xg_comp = [(1/nt_prop) (x_gauss(1)/nt_ar) (nitrog_i/nt_ar) (x_gauss(2)/nt_p) (x_gauss(3)/nt_p) (x_gauss(4)/nt_p) (h2_p/nt_p) (nitrog_f/nt_p)];
xi_comp = [(1/nt_prop) (x_inv(1)/nt_ar) (nitrog_i/nt_ar) (x_inv(2)/nt_p) (x_inv(3)/nt_p) (x_inv(4)/nt_p) (h2_p/nt_p) (nitrog_f/nt_p)];
xr_comp = [(1/nt_prop) (x_ref(1)/nt_ar) (nitrog_i/nt_ar) (x_ref(2)/nt_p) (x_ref(3)/nt_p) (x_ref(4)/nt_p) (h2_p/nt_p) (nitrog_f/nt_p)];
